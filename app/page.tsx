import ShaderCanvas from '@/components/home/ShaderCanvas';
...
const socials = [
  ...
  {
    label: 'GitHub',
    href: 'https://github.com/syotoshix',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22" aria-hidden="true">
  ...
  {
    label: 'CoinMarketCap',
    href: 'https://coinmarketcap.com/community/profile/Syotoshi/',
    icon: (
      // eslint-disable-next-line @next/next/no-img-element
      <img
        src="/portfolio/coinmarketcap-seeklogo.png"
        alt="CoinMarketCap"
        width={24}
        height={24}
        style={{ display: 'block' }}
