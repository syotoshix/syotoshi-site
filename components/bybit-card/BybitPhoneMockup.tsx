...
interface BybitPhoneMockupProps {
  phoneTime:     string
  phoneDate:     string
  notifIcon:     string
  notifMsg:      string
...
export default function BybitPhoneMockup({
  phoneTime,
  phoneDate,
  notifIcon,
  notifMsg,
    ...
    <div className="phone">
      ...
      <div className="ph-notifs">
        <div className={`pn${purchaseIn ? ' in' : ''}`}>
          <div className="pn-icon" style={{ fontSize: '.75rem', fontWeight: 800, color: '#f7a600' }}>
            BYB<span style={{ display:'inline-block',width:'2px',height:'1em',background:'#f7a600',borderRadius:'1px',margin:'0 1px',verticalAlign:'middle'}}/>T
          </div>
          <div className="pn-body">
            <div className="pn-app" style={{ display: 'flex', alignItems: 'center', gap: 3 }}>
              Bybit App <span>{notifIcon}</span>
            </div>
            <div
              className="pn-msg"
